...
private:
  ...
  void analyzeGenSubjets(const reco::GenJet& jet);
   ...
   //--------- functions for groomed jet observables ----------------------------
  void IterativeDeclusteringRec(const reco::Jet& jet,fastjet::PseudoJet *sub1, fastjet::PseudoJet *sub2);
  void IterativeDeclusteringRef(const reco::GenJet& jet,fastjet::PseudoJet *sub1, fastjet::PseudoJet *sub2);
  ...
  struct JRA {
    ...
    float   jtzg[MAXJETS]   = {0};
    float   jtrg[MAXJETS]   = {0};
    float   jtkt[MAXJETS]   = {0};
    float   jtangu[MAXJETS] = {0};
    ...
    float   refzg[MAXJETS]   = {0};
    float   refrg[MAXJETS]   = {0};
    float   refkt[MAXJETS]   = {0};
    ...
    float   genzg[MAXJETS]   = {0};
    float   genrg[MAXJETS]   = {0};
    float   genkt[MAXJETS]   = {0};
    float   genangu[MAXJETS] = {0};
