...
# -------- parameters --------
EVTCUT=0 // Set to 0 to process all events
MC=true;
OUTFOLDERNAME="0324TreeDebug";
INPUTFOLDER="MCpthat15String";
OUTFILETAG="MC_1PD_withjetcuts";

# -------- Apply Cuts or not--------
L1MinBiasBool=true;
HLTMinBiasBool=false;
JetTriggerBool=false;
CCFilterBool=true;
PVFilterBool=true;
zvtxCutBool=true;
JetPtCutBool=true;
JetSelectionsBool=true;
HFEFilterBool=true;
