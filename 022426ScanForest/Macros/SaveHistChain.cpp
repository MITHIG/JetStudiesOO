...
int SaveHistChain() {
    ...
    bool MC = true;
    string outfoldername = "0320MultipleHistMethod";
    ...
    string outfiletag = "pthat15_1PD_5_withjetcuts";
    ...
    string outFileName = Form("../RootFiles/%s/JetSubHist_%s_%sEvts_%s_%s.root",
